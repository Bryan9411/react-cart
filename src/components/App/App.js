...
function App() {
  ...
  const handleDeleteCommodity = (key) => {
    setCarts(carts.filter((cart) => cart.id !== key));
  };
  ...
  return (
    <Root>
      ...
      <Container>
        <About
          carts={carts}
          handleClickAddToCarts={handleClickAddToCarts}
        ...
        {modal && (
          <ModalContainer>
                ...
                <thead>
                  ...
                  {carts.map((cart) => (
                    <Cart
                      cart={cart}
                      key={cart.id}
                      handleDeleteCommodity={handleDeleteCommodity}
                    />
                  ))}
                </thead>
              </table>
            ...
            <ModalFooter>
              <div className="success-button" onClick={handleCheckoutClick}>
                結帳
              </div>
              <div className="cancel-button" onClick={handleCancleClick}>
                取消
              </div>
            </ModalFooter>
          </ModalContainer>
